    ...
    public partial class SeedCompleted : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("786214dc-4b54-4438-a673-412a43f62331"), new DateTime(2024, 8, 12, 17, 19, 43, 306, DateTimeKind.Local).AddTicks(3360), "Atıştırmalık" },
                    { new Guid("daa90872-2b2e-474c-a464-4b0009dfbe0b"), new DateTime(2024, 8, 12, 17, 19, 43, 306, DateTimeKind.Local).AddTicks(3356), "İçecek" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("35bdb1a3-c402-4a7e-910c-5b7b2e79e486"), new DateTime(2024, 8, 12, 17, 19, 43, 306, DateTimeKind.Local).AddTicks(5442), "images/testimage2", "jpg" },
                    { new Guid("c600ef28-de70-45d8-8689-2ace26134f37"), new DateTime(2024, 8, 12, 17, 19, 43, 306, DateTimeKind.Local).AddTicks(5440), "images/testimage", "jpg" }
                });
